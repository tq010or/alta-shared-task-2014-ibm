...
%  IBM Research \\
%  Melbourne, VIC, Australia \\
%  {\tt bohan.ibm@au1.ibm.com} \\ \And
%  Antonio Jimeno Yepes \\
%  IBM Research \\
%  Melbourne, VIC, Australia \\
%  {\tt antonio.jimeno@au1.ibm.com} \\ \And
%  Andrew MacKinlay \\
%  IBM Research \\
%  Melbourne, VIC, Australia \\
%  {\tt admackin@au1.ibm.com}\\ \And
%  Qiang Chen \\
%  IBM Research \\
%  Melbourne, VIC, Australia \\
%  {\tt qiangchen@au1.ibm.com}\\}
...
This shared task is very similar to a well-established NLP task --- named entity recognition (NER) but with a focus on location entities.
...
%TODO: why filtering generates more entries? before filtering is 8M , after filing is 9.8M? Please double check
...
Compared to results from other participants, our system seems to perform below other participating systems, which is cannot be discussed since we are not aware of the implementation of the other systems.
In our own results, we find large disagreements between the results on the dev and test data (0.758 vs 0.726), which might indicate that there is a large difference between the sets and that larger training sets are required to avoid overfitting or that additional sets of features might be considered.
...
%TODO: I think I can offer you our best run results and you may double check whether the examples are still correct. Current discussion is based on our last submission (second to the best).
